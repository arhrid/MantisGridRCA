...
- Participants receive real telemetry from multiple clusters.
- The telemetry includes metrics, traces, and logs.
- Participants receive labeled incidents with known answers.
- The challenge is to build an accurate and efficient agent that finds the root cause of real failures.
- The event provides a sample "gold" dataset for evaluation.
...
- How large are the telemetry datasets?
