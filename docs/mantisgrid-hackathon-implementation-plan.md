...
- Runtime decision: develop locally with a Python environment, but final Track 1 judging requires a root-level Dockerfile and headless `run.py` submission contract.
